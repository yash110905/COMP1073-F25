...
document.addEventListener("DOMContentLoaded", () => {
  ...
  showStoryBtn.addEventListener("click", () => {
    ...
    if (!subject || !verb || !adjective || !place || !object) {
      // Pointer emoji from https://unicode.org/emoji/charts/full-emoji-list.html#1f449
